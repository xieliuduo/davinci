...
export default function(chartProps: IChartProps, drillOptions) {
  ...
  // loadResource('/test.js').then((res) => {
  //   console.log('/test.js', res)
  // })
  // loadResource('/test.css').then((res) => {
  //   console.log('/test.css', res)
  // })
  ...
  if (mapJsonCacheFlag[mapData.currentCode]) {
    ...
    mapJsonCacheFlag[mapData.currentCode] = getMapFile(
      mapData.currentCode
    ).then((json: object) => {
